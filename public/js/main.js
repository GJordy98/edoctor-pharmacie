(function () {
  ...
  if (localStorage.getItem("vyzorlayout") == "horizontal") {
    let html = document.querySelector("html");
    if (html) html.setAttribute("data-nav-layout", "horizontal");
  }
  ...
  function localStorageBackup() {
    ...
    if (localStorage.primaryRGB) {
      ...
      if (themeContainerPrimary) {
        themeContainerPrimary.value = localStorage.primaryRGB;
      }
      let html = document.querySelector("html");
      if (html) html.style.setProperty("--primary-rgb", localStorage.primaryRGB);
    }
    ...
    if (localStorage.vyzorverticalstyles) {
      ...
      if (verticalStyles == "doublemenu") {
        ...
        setTimeout(() => {
          ...
          tooltip.style.setProperty("background-color", "rgb(58, 176, 71)");
          tooltip.style.setProperty("color", "rgb(58, 176, 71)");
