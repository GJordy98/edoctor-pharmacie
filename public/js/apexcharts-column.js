(function () {
    ...
    const stackedoptions = {
        ...
        colors: ["#3ab047", "#ff49cd", "#fdaf22", "#32d484"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    const colors = ['#3ab047', '#ff49cd', '#fdaf22', '#32d484', '#00c9ff', '#ff6757', '#ff6757'];
    ...
    const distributedoptions = {
        ...
        colors: ['#3ab047', '#ff49cd', '#fdaf22', '#32d484', '#00c9ff', '#ff6757', 'rgba(53, 181, 170,1)','rgb(190, 43, 235)'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
