...
(() => {
  ...
  if(headerToggleBtn) headerToggleBtn.addEventListener("click", toggleSidemenu);
  ...
  if (
    !localStorage.getItem("vyzorlayout") &&
    !localStorage.getItem("vyzornavstyles") &&
    !localStorage.getItem("vyzorverticalstyles") &&
...
function toggleSidemenu() {
  ...
  if (window.innerWidth >= 992) {
    if (sidemenuType === "vertical") {
      ...
      if(mainContentDiv) mainContentDiv.removeEventListener("click", icontextClose);
      ...
      switch (verticalStyle) {
        ...
        case "icontext":
          ...
          if (html.getAttribute("data-toggled") === "icon-text-close") {
            ...
            if (sidebar) sidebar.removeEventListener("click", icontextOpen);
            if(mainContentDiv) mainContentDiv.removeEventListener("click", icontextClose);
          } else {
            html.setAttribute("data-toggled", "icon-text-close");
            if (window.innerWidth >= 992) {
              if (sidebar) sidebar.addEventListener("click", icontextOpen);
              if(mainContentDiv) mainContentDiv.addEventListener("click", icontextClose);
            } else {
              if (sidebar) sidebar.removeEventListener("click", icontextOpen);
              if(mainContentDiv) mainContentDiv.removeEventListener("click", icontextClose);
            }
...
function switcherArrowFn() {
  ...
  if (slideLeft) {
    ...
    if (menuNav.scrollWidth > mainContainer1.offsetWidth) {
      ...
      let menuNavInstance = document.querySelector(".main-menu");
      if (menuNavInstance) {
        menuNavInstance.style.marginLeft = "0px";
        menuNavInstance.style.marginRight = "0px";
      }
      slideLeft.classList.add("d-none");
    }
  ...
  (element) => {
    if (document.getElementById(element)) {
      document.getElementById(element).addEventListener("click", () => {
        let menuNav = document.querySelector(".main-menu");
        let mainContainer1 = document.querySelector(".main-sidebar");
        let slideRightBtn = document.getElementById("slide-right");
        setTimeout(() => {
          if (menuNav && mainContainer1 && slideRightBtn) {
            if (menuNav.offsetWidth > mainContainer1.offsetWidth) {
              slideRightBtn.classList.remove("d-none");
            } else {
              slideRightBtn.classList.add("d-none");
            }
          }
        }, 100);
      });
