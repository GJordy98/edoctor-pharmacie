                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-amber-400/50 focus:ring-offset-2 ${
                                                    s.is_guard ? 'bg-amber-400' : 'bg-[#E2E8F0]'
                                                }`}
                                                role="switch"
                                                aria-checked={s.is_guard}
                                                title={s.is_guard ? 'Pharmacie de garde' : 'Non de garde'}
                                            >
                                                <span className="sr-only">Toggle De garde</span>
                                                <span
                                                    aria-hidden="true"
                                                    className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
                                                        s.is_guard ? 'translate-x-5' : 'translate-x-0'
                                                    }`}
                                                />
                                            </button>
                                        </div>
